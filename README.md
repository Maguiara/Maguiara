...
### 🎓 Sobre mí
Soy **estudiante del Grado en Ingeniería Informática** en la **Universidad de La Laguna (ULL)**.

### 🌱 Actualmente aprendiendo
Estoy cursando la asignatura de **Procesadores de Lenguajes**, profundizando en:
- 🛠️ Desarrollo de compiladores.
- ⚙️ Herramientas: **Flex**, **Bison** y **C/C++**.
- 🐳 Virtualización de entornos con **Docker** y **DevContainers**.
